...
export const prismaHookWithDynamic = Prisma.validator<Prisma.PrismaHookArgs>()({
    include: {
        dynamicData: true,
    },
});

export type PrismaHookWithDynamic = Prisma.PrismaHookGetPayload<typeof prismaHookWithDynamic>;
