...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancerV3: `https://gateway.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmeGDQcYMBJiZVYa6MkveWoVkBVT8KTdKeJWnhb8WpMj1p`,
        balancerPoolsV3: `https://gateway.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmbTSYthG7jeK8A6CYTStnv879t96wKVarhZTmSR1eMYMw`,
