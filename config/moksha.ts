...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancer: `https://api.studio.thegraph.com/query/87733/symmetric-v-4-moksha-pools/version/latest`,
        balancerV3: `https://api.studio.thegraph.com/query/87733/symmetric-v-4-moksha-pools/version/latest`,
        balancerPoolsV3: `https://api.studio.thegraph.com/query/87733/symmetric-v-4-moksha-pools/version/latest`,
    ...
    rpcUrl: env.DRPC_API_KEY
        ? `https://lb.drpc.org/ogrpc?network=moksha&dkey=${env.DRPC_API_KEY}`
        : 'https://gateway.tenderly.co/public/moksha',
    ...
    hooks: {
        ['0x2d8d157fd6cf773624d97808d77081ee45caa7d4']: 'LOTTERY',
        ['0x3c194f14527b4e02b0d09274eca72ccb67613fac']: 'LOTTERY',
