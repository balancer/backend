...
export default <NetworkData>{
    ...
    subgraphs: {
        ...
        balancerPoolsV3: `https://gateway.thegraph.com/api/${env.THEGRAPH_API_KEY_BALANCER}/deployments/id/QmcUBcE7MgBwNjjSzM1VN8KMpgpSFdBMKDoeFbJgZnA75z`,
    ...
    aprHandlers: {
        ...
        ybAprHandler: {
            ...
            defillama: [
                ...
                {
                    defillamaPoolId: '0aedb3f6-9298-49de-8bb0-2f611a4df784',
                    tokenAddress: '0x1202f5c7b4b9e47a1a484e8b270be34dbbc75055',
                },
                {
