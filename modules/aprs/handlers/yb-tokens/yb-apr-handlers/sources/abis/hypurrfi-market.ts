export const abi = [
    {
        inputs: [
            ...
            { internalType: 'bytes', name: '_customConfigData', type: 'bytes' },
        ],
        stateMutability: 'nonpayable',
        type: 'constructor',
    },
    { inputs: [], name: 'AccessControlRevoked', type: 'error' },
    { inputs: [], name: 'BadProtocolFee', type: 'error' },
    { inputs: [], name: 'BadSwapper', type: 'error' },
    { inputs: [], name: 'BorrowerSolvent', type: 'error' },
    { inputs: [], name: 'ExceedsBorrowLimit', type: 'error' },
    { inputs: [], name: 'ExceedsDepositLimit', type: 'error' },
    { inputs: [], name: 'ExceedsMaxOracleDeviation', type: 'error' },
    {
        inputs: [
    ...
    { inputs: [], name: 'InterestPaused', type: 'error' },
    {
        inputs: [
    ...
    { inputs: [], name: 'RepayPaused', type: 'error' },
    { inputs: [], name: 'SetterRevoked', type: 'error' },
    {
        inputs: [
    ...
    { inputs: [], name: 'WithdrawPaused', type: 'error' },
    {
        anonymous: false,
        inputs: [
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'interestEarned', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'rate', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'feesAmount', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'feesShare', type: 'uint256' },
        ],
        name: 'AddInterest',
        type: 'event',
    },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint32', name: 'newFee', type: 'uint32' }],
        name: 'ChangeFee',
        type: 'event',
    },
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: true, internalType: 'address', name: 'borrower', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'amountToRepay', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'shares', type: 'uint256' },
        ],
        name: 'RepayAsset',
        type: 'event',
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'borrowLimit', type: 'uint256' }],
        name: 'RevokeBorrowAccessControl',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'depositLimit', type: 'uint256' }],
        name: 'RevokeDepositAccessControl',
        type: 'event',
    },
    { anonymous: false, inputs: [], name: 'RevokeInterestAccessControl', type: 'event' },
    { anonymous: false, inputs: [], name: 'RevokeLiquidateAccessControl', type: 'event' },
    { anonymous: false, inputs: [], name: 'RevokeLiquidationFeeSetter', type: 'event' },
    { anonymous: false, inputs: [], name: 'RevokeMaxLTVSetter', type: 'event' },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'address', name: 'oldCircuitBreaker', type: 'address' },
            { indexed: false, internalType: 'address', name: 'newCircuitBreaker', type: 'address' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'oldCleanLiquidationFee', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'oldDirtyLiquidationFee', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'oldProtocolLiquidationFee', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newCleanLiquidationFee', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newDirtyLiquidationFee', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newProtocolLiquidationFee', type: 'uint256' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'oldMaxLTV', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newMaxLTV', type: 'uint256' },
        ],
        name: 'SetMaxLTV',
        type: 'event',
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint32', name: 'oldMaxOracleDeviation', type: 'uint32' },
            { indexed: false, internalType: 'address', name: 'newOracle', type: 'address' },
            { indexed: false, internalType: 'uint32', name: 'newMaxOracleDeviation', type: 'uint32' },
        ],
        name: 'SetOracleInfo',
        type: 'event',
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'address', name: 'oldRateContract', type: 'address' },
            { indexed: false, internalType: 'address', name: 'newRateContract', type: 'address' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'lowExchangeRate', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'highExchangeRate', type: 'uint256' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'oldRatePerSec', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'oldFullUtilizationRate', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newRatePerSec', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'newFullUtilizationRate', type: 'uint256' },
        ],
        name: 'UpdateRate',
        type: 'event',
    },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint128', name: 'shares', type: 'uint128' },
            { indexed: false, internalType: 'address', name: 'recipient', type: 'address' },
            { indexed: false, internalType: 'uint256', name: 'amountToTransfer', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'collateralAmount', type: 'uint256' },
        ],
        name: 'WithdrawFees',
        type: 'event',
    ...
    {
        inputs: [{ internalType: 'bool', name: '_returnAccounting', type: 'bool' }],
        name: 'addInterest',
        outputs: [
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint32', name: 'maxOracleDeviation', type: 'uint32' },
            { internalType: 'uint184', name: 'lastTimestamp', type: 'uint184' },
            { internalType: 'uint256', name: 'lowExchangeRate', type: 'uint256' },
            { internalType: 'uint256', name: 'highExchangeRate', type: 'uint256' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: '_DEVIATION_PRECISION', type: 'uint256' },
            { internalType: 'uint256', name: '_RATE_PRECISION', type: 'uint256' },
    ...
    },
    {
        ...
        name: 'maxDeposit',
        outputs: [{ internalType: 'uint256', name: '_maxAssets', type: 'uint256' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    },
    {
        inputs: [{ internalType: 'address', name: '_receiver', type: 'address' }],
        name: 'maxMint',
        outputs: [{ internalType: 'uint256', name: '_maxShares', type: 'uint256' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    { inputs: [], name: 'pauseBorrow', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'pauseDeposit', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
    ...
    },
    {
        ...
        outputs: [{ internalType: 'uint256', name: '_sharesToBurn', type: 'uint256' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    },
    {
        inputs: [],
        name: 'rateContract',
        outputs: [{ internalType: 'contract IRateCalculatorV2', name: '', type: 'address' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    {
        inputs: [{ internalType: 'uint256', name: '_borrowLimit', type: 'uint256' }],
    ...
    { inputs: [], name: 'revokeInterestAccessControl', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeLiquidateAccessControl', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeLiquidationFeeSetter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeMaxLTVSetter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeOracleInfoSetter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeRateContractSetter', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeRepayAccessControl', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    { inputs: [], name: 'revokeWithdrawAccessControl', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
    ...
    {
        inputs: [{ internalType: 'address', name: '_newCircuitBreaker', type: 'address' }],
        name: 'setCircuitBreaker',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    {
        inputs: [
            { internalType: 'uint256', name: '_newCleanLiquidationFee', type: 'uint256' },
            { internalType: 'uint256', name: '_newDirtyLiquidationFee', type: 'uint256' },
            { internalType: 'uint256', name: '_newProtocolLiquidationFee', type: 'uint256' },
        ],
        name: 'setLiquidationFees',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    {
        inputs: [{ internalType: 'uint256', name: '_newMaxLTV', type: 'uint256' }],
        name: 'setMaxLTV',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
        inputs: [
            ...
            { internalType: 'uint32', name: '_newMaxOracleDeviation', type: 'uint32' },
        ],
        name: 'setOracle',
        outputs: [],
        stateMutability: 'nonpayable',
    ...
    {
        inputs: [{ internalType: 'address', name: '_newRateContract', type: 'address' }],
        name: 'setRateContract',
        outputs: [],
        stateMutability: 'nonpayable',
        type: 'function',
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'bool', name: '_previewInterest', type: 'bool' },
        ],
        name: 'toAssetAmount',
        outputs: [{ internalType: 'uint256', name: '_amount', type: 'uint256' }],
        stateMutability: 'view',
    ...
    { inputs: [], name: 'unpause', outputs: [], stateMutability: 'nonpayable', type: 'function' },
    {
        ...
        name: 'updateExchangeRate',
        outputs: [
            { internalType: 'bool', name: '_isBorrowAllowed', type: 'bool' },
            { internalType: 'uint256', name: '_lowExchangeRate', type: 'uint256' },
            { internalType: 'uint256', name: '_highExchangeRate', type: 'uint256' },
        ],
        stateMutability: 'nonpayable',
        type: 'function',
    },
