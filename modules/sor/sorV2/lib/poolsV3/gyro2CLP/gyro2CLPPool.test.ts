...
import { Gyro2CLPPool } from './gyro2CLPPool';
...
// TODO: refactor tests to use Gyro2CLPPool

describe('SOR V3 Stable Pool Tests', () => {
    let amp: string;
    let scalingFactors: bigint[];
    let aggregateSwapFee: bigint;
    let stablePool: Gyro2CLPPool;
    let stablePoolWithHook: Gyro2CLPPool;
    ...
    beforeAll(() => {
        ...
        stablePool = Gyro2CLPPool.fromPrismaPool(stablePrismaPool, []);
        ...
        stablePoolWithHook = Gyro2CLPPool.fromPrismaPool(stablePrismaPoolWithHook, []);
    });
