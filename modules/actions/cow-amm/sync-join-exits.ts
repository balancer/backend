...
import { joinExitCowAmmTransformer } from '../../sources/transformers/join-exit-cowamm-transformer';
...
export const syncJoinExits = async (
    ...
    // Prepare DB entries
    const dbEntries = await joinExitCowAmmTransformer(addRemoves, chain, 1);
