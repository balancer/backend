...
export const gnosisNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            gnosisNetworkData.balancer.v2.yieldProtocolFeePercentage,
            gnosisNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(gnosisNetworkData.balancer.v2.swapProtocolFeePercentage),
