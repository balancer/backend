...
export const mainnetNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            data.ybAprConfig,
            data.chain.prismaId,
            data.balancer.v2.yieldProtocolFeePercentage,
            data.balancer.v2.swapProtocolFeePercentage,
        ),
        new PhantomStableAprService(data.chain.prismaId, data.balancer.v2.yieldProtocolFeePercentage),
        new BoostedPoolAprService(),
        new SwapFeeAprService(data.balancer.v2.swapProtocolFeePercentage),
