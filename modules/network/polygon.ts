...
export const polygonNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            polygonNetworkData.balancer.v2.yieldProtocolFeePercentage,
            polygonNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(polygonNetworkData.balancer.v2.swapProtocolFeePercentage),
