...
export const optimismNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            optimismNetworkData.balancer.v2.yieldProtocolFeePercentage,
            optimismNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(optimismNetworkData.balancer.v2.swapProtocolFeePercentage),
