...
export const mokshaNetworkData = config.MOKSHA;

export const mokshaNetworkConfig: NetworkConfig = {
    data: mokshaNetworkData,
    provider: new ethers.providers.JsonRpcProvider({ url: mokshaNetworkData.rpcUrl, timeout: 60000 }),
    poolAprServices: [
        new YbTokensAprService(mokshaNetworkData.ybAprConfig, mokshaNetworkData.chain.prismaId),
    ...
    services: {
        balancerSubgraphService: new BalancerSubgraphService(
            mokshaNetworkData.subgraphs.balancer,
            mokshaNetworkData.chain.prismaId,
        ),
    },
    /*
