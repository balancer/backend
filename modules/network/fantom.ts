...
export const fantomNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            fantomNetworkData.balancer.v2.yieldProtocolFeePercentage,
            fantomNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(fantomNetworkData.balancer.v2.swapProtocolFeePercentage),
