...
export const zkevmNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            zkevmNetworkData.balancer.v2.yieldProtocolFeePercentage,
            zkevmNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(zkevmNetworkData.balancer.v2.swapProtocolFeePercentage),
