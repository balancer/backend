...
export const arbitrumNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            arbitrumNetworkData.balancer.v2.yieldProtocolFeePercentage,
            arbitrumNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(arbitrumNetworkData.balancer.v2.swapProtocolFeePercentage),
