...
export const avalancheNetworkConfig: NetworkConfig = {
    ...
    poolAprServices: [
        new YbTokensAprService(
            ...
            avalancheNetworkData.balancer.v2.yieldProtocolFeePercentage,
            avalancheNetworkData.balancer.v2.swapProtocolFeePercentage,
        ),
        ...
        new SwapFeeAprService(avalancheNetworkData.balancer.v2.swapProtocolFeePercentage),
