export default [
        ...
        inputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'priceShiftDailyRate', type: 'uint256' },
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'priceShiftDailyRate', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'priceShiftDailyRateInSeconds', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        outputs: [{ internalType: 'uint256', name: 'balanceRatio', type: 'uint256' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'priceShiftDailyRateInSeconds', type: 'uint256' },
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'initialMaxPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialTargetPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialPriceShiftDailyRate', type: 'uint256' },
                    ...
                    { internalType: 'uint256', name: 'maxPriceShiftDailyRate', type: 'uint256' },
    ...
    {
        inputs: [{ internalType: 'uint256', name: 'newPriceShiftDailyRate', type: 'uint256' }],
