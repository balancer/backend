export default [
        ...
        inputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'dailyPriceShiftExponent', type: 'uint256' },
                    { internalType: 'uint64', name: 'centerednessMargin', type: 'uint64' },
                    { internalType: 'uint256', name: 'initialMinPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialMaxPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialTargetPrice', type: 'uint256' },
                ],
    ...
    {
        inputs: [{ internalType: 'uint256', name: 'fourthRootPriceRatioDelta', type: 'uint256' }],
    ...
    {
        inputs: [
            { internalType: 'uint256', name: 'resolvedStartTime', type: 'uint256' },
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'centerednessMargin', type: 'uint256' }],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'dailyPriceShiftExponent', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'dailyPriceShiftBase', type: 'uint256' },
        ],
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint32', name: 'lastTimestamp', type: 'uint32' }],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'startFourthRootPriceRatio', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'endFourthRootPriceRatio', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'priceRatioUpdateStartTime', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'priceRatioUpdateEndTime', type: 'uint256' },
        ],
    ...
    },
    {
        anonymous: false,
        inputs: [
            { indexed: false, internalType: 'uint256', name: 'virtualBalanceA', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'virtualBalanceB', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        outputs: [
            { internalType: 'uint256', name: 'currentVirtualBalanceA', type: 'uint256' },
            { internalType: 'uint256', name: 'currentVirtualBalanceB', type: 'uint256' },
    ...
    {
        inputs: [
            { internalType: 'contract IERC20', name: 'referenceToken', type: 'address' },
            { internalType: 'uint256', name: 'referenceAmountIn', type: 'uint256' },
        ],
        name: 'computeInitialBalances',
        outputs: [{ internalType: 'uint256[]', name: 'initialBalances', type: 'uint256[]' }],
        stateMutability: 'view',
        type: 'function',
    },
    {
    ...
    },
    {
        ...
        outputs: [
            { internalType: 'uint256', name: 'virtualBalanceA', type: 'uint256' },
            { internalType: 'uint256', name: 'virtualBalanceB', type: 'uint256' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    },
    {
        ...
        outputs: [
            {
                components: [
                    { internalType: 'uint96', name: 'startFourthRootPriceRatio', type: 'uint96' },
                    { internalType: 'uint96', name: 'endFourthRootPriceRatio', type: 'uint96' },
                    { internalType: 'uint32', name: 'priceRatioUpdateStartTime', type: 'uint32' },
                    { internalType: 'uint32', name: 'priceRatioUpdateEndTime', type: 'uint32' },
                ],
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256[]', name: 'lastVirtualBalances', type: 'uint256[]' },
                    { internalType: 'uint256', name: 'dailyPriceShiftExponent', type: 'uint256' },
                    { internalType: 'uint256', name: 'dailyPriceShiftBase', type: 'uint256' },
                    { internalType: 'uint256', name: 'centerednessMargin', type: 'uint256' },
                    { internalType: 'uint256', name: 'currentPriceRatio', type: 'uint256' },
                    { internalType: 'uint256', name: 'currentFourthRootPriceRatio', type: 'uint256' },
                    { internalType: 'uint256', name: 'startFourthRootPriceRatio', type: 'uint256' },
                    { internalType: 'uint256', name: 'endFourthRootPriceRatio', type: 'uint256' },
                    { internalType: 'uint32', name: 'priceRatioUpdateStartTime', type: 'uint32' },
                    { internalType: 'uint32', name: 'priceRatioUpdateEndTime', type: 'uint32' },
        ...
        outputs: [
            {
                components: [
                    ...
                    { internalType: 'uint256', name: 'initialMaxPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialTargetPrice', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialDailyPriceShiftExponent', type: 'uint256' },
                    { internalType: 'uint256', name: 'initialCenterednessMargin', type: 'uint256' },
                    { internalType: 'uint256', name: 'minCenterednessMargin', type: 'uint256' },
                    { internalType: 'uint256', name: 'maxCenterednessMargin', type: 'uint256' },
                    { internalType: 'uint256', name: 'minTokenBalanceScaled18', type: 'uint256' },
                    { internalType: 'uint256', name: 'minPoolCenteredness', type: 'uint256' },
                    { internalType: 'uint256', name: 'maxDailyPriceShiftExponent', type: 'uint256' },
                    { internalType: 'uint256', name: 'minPriceRatioUpdateDuration', type: 'uint256' },
                    { internalType: 'uint256', name: 'minFourthRootPriceRatioDelta', type: 'uint256' },
                ],
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'bool', name: 'virtualBalancesChanged', type: 'bool' },
        ],
        stateMutability: 'view',
        type: 'function',
    },
    ...
    },
    {
        ...
        name: 'onSwap',
        outputs: [{ internalType: 'uint256', name: 'amountCalculatedScaled18', type: 'uint256' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
    ...
    {
        inputs: [{ internalType: 'uint256', name: 'newCenterednessMargin', type: 'uint256' }],
    ...
    {
        inputs: [{ internalType: 'uint256', name: 'newDailyPriceShiftExponent', type: 'uint256' }],
    ...
    },
    {
        inputs: [
            { internalType: 'uint256', name: 'endFourthRootPriceRatio', type: 'uint256' },
            { internalType: 'uint256', name: 'priceRatioUpdateStartTime', type: 'uint256' },
            { internalType: 'uint256', name: 'priceRatioUpdateEndTime', type: 'uint256' },
        ],
        name: 'setPriceRatioState',
        outputs: [{ internalType: 'uint256', name: 'actualPriceRatioUpdateStartTime', type: 'uint256' }],
        stateMutability: 'nonpayable',
        type: 'function',
    },
    {
