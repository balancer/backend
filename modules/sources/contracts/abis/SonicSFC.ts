export default [
    ...
    },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: 'uint256', name: 'received', type: 'uint256' },
            { indexed: false, internalType: 'uint256', name: 'distributed', type: 'uint256' },
        ],
        name: 'DistributedExtraRewards',
        type: 'event',
    },
    {
        anonymous: false,
    ...
    },
    {
        inputs: [
            ...
            { internalType: 'bool', name: 'withBurn', type: 'bool' },
        ],
        name: 'distributeExtraReward',
        outputs: [],
        stateMutability: 'payable',
        type: 'function',
    },
